...
# comment line it will not execute
...
interger --> int  --> whole number
float  --> float  --> decimal number
string  --> str   --> character (collection of charaters are called as string)
boolean  --> bool  --> true or flase

2. non primitive data type

list ---> [  list data type stored in square braces]
tuple --> (tuple data types are stored in round braces)
